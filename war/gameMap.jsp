...
///Hai duong
  ...
  this.count_++;
  if(this.count_== PuzzleDemo.NUM_PIECES_){	
	  alert ('Congratulation!'+'Do you want to try again!');
	  this.setDifficultyStyle_();
	  this.resetGame_(); 
	};   
	/////
...
function initMap() {
  ...
  (new PuzzleDemo).init(map);
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCygRXb-HJURc5BaMAcdBXrf_q1va_Q2pc&libraries=geometry&callback=initMap"
        async defer></script>
  </body>
</html>