...
%>     
 <head id="mainHead">
   ...
   <!-- <h1 align="center" style="bottom: 100%"><img src="fightGhost.jpg"></h1> --> 
	...
	<div class = "tabPage" id="listTab"> <ul>
...
<body id="Header">
	<div id = "MainPage" align="center">	
		<table>
			<tr>
		        <td width="35%">Available Servlets:</td>  
		        <td width="65%"><a href="gae_application1">GAE_Application1</a></td>      
		      </tr>
			<tr>
				<td><div id="dataBox"></div></td>
				<td>	
					<table>
						<tr><td><select id="tableMode">Mode<option>All</option><option>Sensor</option><option>IP</option><option>Date</option><option>Temperature</option><option>Humidity</option></select></td></tr>
						<tr><td><div id="tableNodeInfo"></div></td></tr>
						<tr>
							<td>
								<div id="containerHD">
							    	<details>
